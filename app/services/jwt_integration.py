...
# -*- coding: utf-8 -*-
"""
Integração JWT com Sistema de Gestão de Frotas
Permite autenticação compartilhada entre os sistemas
"""
...
def decode_jwt_token(token: str) -> Optional[Dict[Any, Any]]:
    """
    Decodifica um token JWT do sistema de frotas
    """
    try:
...
def inject_integration_context():
    ...
    return {
        ...
        'is_jwt_authenticated': session.get('auth_source') == 'frotas_jwt',
